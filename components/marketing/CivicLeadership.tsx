  ...
  return (
    <div className="bg-[#111] py-32 px-6 border-b border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* Leadership Row - Pure Display Component */}
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-12 md:gap-16 mb-32 border-t border-white/10 pt-24">
          {leaders.map((leader, i) => (
            <div key={leader.id || i} className="flex flex-col items-center text-center group relative">
              ...
              <div className="relative z-10 flex flex-col items-center w-full px-2">
                <h4 className="text-white font-black text-lg md:text-xl uppercase italic tracking-tighter mb-2">
                  {leader.name}
                </h4>
                
                <p className="text-gray-500 text-[10px] md:text-xs uppercase font-bold tracking-[0.2em] leading-tight mx-auto">
                  {leader.title}
                </p>
              </div>
            </div>
